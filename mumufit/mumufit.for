...
c --- energy in c.m.s., it will be filled from debeam array
      real*8 decm(iarrlen)
      data decm/
     &  210.316,211.,211.749,212.,213.316/
c     &  210.316,211.749,213.316/
c     &  211.316,212.749,214.316/
c --- error of decm, here it considered to be 50 keV
...
c --- filename of minuit input command file
      character*(*) cminfile
      parameter ( cminfile = 'mumufit' )
c --- filename of output files
      character*(*) chisfile
      parameter ( chisfile = 'mumufit' )
